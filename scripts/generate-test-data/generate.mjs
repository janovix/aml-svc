...
/** Valid 7-digit SAT codes from catalogs/economic-activities.csv */
const ECO_ACT = [
	"1110100",
	"1110400",
	"1220100",
...
/** Valid 7-digit SAT codes from catalogs/business-activities.csv (giro mercantil) */
const BIZ_ACT = [
	"5520014",
	"5610015",
	"1100001",
...
function buildMoral(i) {
	...
	return {
		...
		commercial_activity_code: BIZ_ACT[i % BIZ_ACT.length],
		gender: "",
		occupation: "",
		marital_status: "",

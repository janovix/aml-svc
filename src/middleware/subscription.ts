...
/**
 * Extended variables with subscription info
 */
 ...
 *
 * @param metric - The usage metric to check (notices, alerts, transactions)
 *
 * @example
 * ```typescript
 * // Add to route that creates notices
 * router.post("/notices", authMiddleware(), requireUsageQuota("notices"), async (c) => {

...
WHERE NOT EXISTS (
    ...
    AND normalizedName = lower(trim('Acura'))
);
...
WHERE NOT EXISTS (SELECT 1 FROM catalog_items WHERE catalogId = (SELECT id FROM catalogs WHERE key = 'vehicle-brands') AND normalizedName = lower(trim('Alfa Romeo')));
...
WHERE NOT EXISTS (SELECT 1 FROM catalog_items WHERE catalogId = (SELECT id FROM catalogs WHERE key = 'vehicle-brands') AND normalizedName = lower(trim('Aston Martin')));
...
WHERE NOT EXISTS (SELECT 1 FROM catalog_items WHERE catalogId = (SELECT id FROM catalogs WHERE key = 'vehicle-brands') AND normalizedName = lower(trim('Audi')));
...
WHERE NOT EXISTS (SELECT 1 FROM catalog_items WHERE catalogId = (SELECT id FROM catalogs WHERE key = 'vehicle-brands') AND normalizedName = lower(trim('Bentley')));
...
WHERE NOT EXISTS (SELECT 1 FROM catalog_items WHERE catalogId = (SELECT id FROM catalogs WHERE key = 'vehicle-brands') AND normalizedName = lower(trim('BMW')));
...
WHERE NOT EXISTS (SELECT 1 FROM catalog_items WHERE catalogId = (SELECT id FROM catalogs WHERE key = 'vehicle-brands') AND normalizedName = lower(trim('Buick')));
...
WHERE NOT EXISTS (SELECT 1 FROM catalog_items WHERE catalogId = (SELECT id FROM catalogs WHERE key = 'vehicle-brands') AND normalizedName = lower(trim('Cadillac')));
...
WHERE NOT EXISTS (SELECT 1 FROM catalog_items WHERE catalogId = (SELECT id FROM catalogs WHERE key = 'vehicle-brands') AND normalizedName = lower(trim('Chevrolet')));
...
WHERE NOT EXISTS (SELECT 1 FROM catalog_items WHERE catalogId = (SELECT id FROM catalogs WHERE key = 'vehicle-brands') AND normalizedName = lower(trim('Chrysler')));
...
WHERE NOT EXISTS (SELECT 1 FROM catalog_items WHERE catalogId = (SELECT id FROM catalogs WHERE key = 'vehicle-brands') AND normalizedName = lower(trim('Citroën')));
...
WHERE NOT EXISTS (SELECT 1 FROM catalog_items WHERE catalogId = (SELECT id FROM catalogs WHERE key = 'vehicle-brands') AND normalizedName = lower(trim('Dodge')));
...
WHERE NOT EXISTS (SELECT 1 FROM catalog_items WHERE catalogId = (SELECT id FROM catalogs WHERE key = 'vehicle-brands') AND normalizedName = lower(trim('Ferrari')));
...
WHERE NOT EXISTS (SELECT 1 FROM catalog_items WHERE catalogId = (SELECT id FROM catalogs WHERE key = 'vehicle-brands') AND normalizedName = lower(trim('Fiat')));
...
WHERE NOT EXISTS (SELECT 1 FROM catalog_items WHERE catalogId = (SELECT id FROM catalogs WHERE key = 'vehicle-brands') AND normalizedName = lower(trim('Ford')));
...
WHERE NOT EXISTS (SELECT 1 FROM catalog_items WHERE catalogId = (SELECT id FROM catalogs WHERE key = 'vehicle-brands') AND normalizedName = lower(trim('Genesis')));
...
WHERE NOT EXISTS (SELECT 1 FROM catalog_items WHERE catalogId = (SELECT id FROM catalogs WHERE key = 'vehicle-brands') AND normalizedName = lower(trim('GMC')));
...
WHERE NOT EXISTS (SELECT 1 FROM catalog_items WHERE catalogId = (SELECT id FROM catalogs WHERE key = 'vehicle-brands') AND normalizedName = lower(trim('Honda')));
...
WHERE NOT EXISTS (SELECT 1 FROM catalog_items WHERE catalogId = (SELECT id FROM catalogs WHERE key = 'vehicle-brands') AND normalizedName = lower(trim('Hyundai')));
...
WHERE NOT EXISTS (SELECT 1 FROM catalog_items WHERE catalogId = (SELECT id FROM catalogs WHERE key = 'vehicle-brands') AND normalizedName = lower(trim('Infiniti')));
...
WHERE NOT EXISTS (SELECT 1 FROM catalog_items WHERE catalogId = (SELECT id FROM catalogs WHERE key = 'vehicle-brands') AND normalizedName = lower(trim('Jaguar')));
...
WHERE NOT EXISTS (SELECT 1 FROM catalog_items WHERE catalogId = (SELECT id FROM catalogs WHERE key = 'vehicle-brands') AND normalizedName = lower(trim('Jeep')));
...
WHERE NOT EXISTS (SELECT 1 FROM catalog_items WHERE catalogId = (SELECT id FROM catalogs WHERE key = 'vehicle-brands') AND normalizedName = lower(trim('Kia')));
...
WHERE NOT EXISTS (SELECT 1 FROM catalog_items WHERE catalogId = (SELECT id FROM catalogs WHERE key = 'vehicle-brands') AND normalizedName = lower(trim('Lamborghini')));
...
WHERE NOT EXISTS (SELECT 1 FROM catalog_items WHERE catalogId = (SELECT id FROM catalogs WHERE key = 'vehicle-brands') AND normalizedName = lower(trim('Land Rover')));
...
WHERE NOT EXISTS (SELECT 1 FROM catalog_items WHERE catalogId = (SELECT id FROM catalogs WHERE key = 'vehicle-brands') AND normalizedName = lower(trim('Lexus')));
...
WHERE NOT EXISTS (SELECT 1 FROM catalog_items WHERE catalogId = (SELECT id FROM catalogs WHERE key = 'vehicle-brands') AND normalizedName = lower(trim('Lincoln')));
...
WHERE NOT EXISTS (SELECT 1 FROM catalog_items WHERE catalogId = (SELECT id FROM catalogs WHERE key = 'vehicle-brands') AND normalizedName = lower(trim('Maserati')));
...
WHERE NOT EXISTS (SELECT 1 FROM catalog_items WHERE catalogId = (SELECT id FROM catalogs WHERE key = 'vehicle-brands') AND normalizedName = lower(trim('Mazda')));
...
WHERE NOT EXISTS (SELECT 1 FROM catalog_items WHERE catalogId = (SELECT id FROM catalogs WHERE key = 'vehicle-brands') AND normalizedName = lower(trim('McLaren')));
...
WHERE NOT EXISTS (SELECT 1 FROM catalog_items WHERE catalogId = (SELECT id FROM catalogs WHERE key = 'vehicle-brands') AND normalizedName = lower(trim('Mercedes-Benz')));
...
WHERE NOT EXISTS (SELECT 1 FROM catalog_items WHERE catalogId = (SELECT id FROM catalogs WHERE key = 'vehicle-brands') AND normalizedName = lower(trim('Mini')));
...
WHERE NOT EXISTS (SELECT 1 FROM catalog_items WHERE catalogId = (SELECT id FROM catalogs WHERE key = 'vehicle-brands') AND normalizedName = lower(trim('Mitsubishi')));
...
WHERE NOT EXISTS (SELECT 1 FROM catalog_items WHERE catalogId = (SELECT id FROM catalogs WHERE key = 'vehicle-brands') AND normalizedName = lower(trim('Nissan')));
...
WHERE NOT EXISTS (SELECT 1 FROM catalog_items WHERE catalogId = (SELECT id FROM catalogs WHERE key = 'vehicle-brands') AND normalizedName = lower(trim('Porsche')));
...
WHERE NOT EXISTS (SELECT 1 FROM catalog_items WHERE catalogId = (SELECT id FROM catalogs WHERE key = 'vehicle-brands') AND normalizedName = lower(trim('Ram')));
...
WHERE NOT EXISTS (SELECT 1 FROM catalog_items WHERE catalogId = (SELECT id FROM catalogs WHERE key = 'vehicle-brands') AND normalizedName = lower(trim('Rolls-Royce')));
...
WHERE NOT EXISTS (SELECT 1 FROM catalog_items WHERE catalogId = (SELECT id FROM catalogs WHERE key = 'vehicle-brands') AND normalizedName = lower(trim('Subaru')));
...
WHERE NOT EXISTS (SELECT 1 FROM catalog_items WHERE catalogId = (SELECT id FROM catalogs WHERE key = 'vehicle-brands') AND normalizedName = lower(trim('Tesla')));
...
WHERE NOT EXISTS (SELECT 1 FROM catalog_items WHERE catalogId = (SELECT id FROM catalogs WHERE key = 'vehicle-brands') AND normalizedName = lower(trim('Toyota')));
...
WHERE NOT EXISTS (SELECT 1 FROM catalog_items WHERE catalogId = (SELECT id FROM catalogs WHERE key = 'vehicle-brands') AND normalizedName = lower(trim('Volkswagen')));
...
WHERE NOT EXISTS (SELECT 1 FROM catalog_items WHERE catalogId = (SELECT id FROM catalogs WHERE key = 'vehicle-brands') AND normalizedName = lower(trim('Volvo')));

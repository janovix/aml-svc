...
const CSV_URL = "https://catalogs.janovix.com/economic-activities.csv";
...
function generateSql(catalogId, items) {
	...
	sql.push(`
		...
		VALUES ('${catalogId}', '${CATALOG_KEY}', 'Economic Activities', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
	`);
